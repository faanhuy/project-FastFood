...
public class ApproveFlashSaleCommandHandler(
    IFlashSaleRepository flashSaleRepository,
    IProductRepository productRepository,
    IUnitOfWork unitOfWork,
    ICacheService cache) : IRequestHandler<ApproveFlashSaleCommand, FlashSaleDto>
{
    public async Task<FlashSaleDto> Handle(ApproveFlashSaleCommand request, CancellationToken cancellationToken)
    {
        ...
        flashSale.Approve(request.ApprovedBy);
