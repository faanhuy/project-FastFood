...
public class RejectFlashSaleCommandHandler(
    IFlashSaleRepository flashSaleRepository,
    IProductRepository productRepository,
    IUnitOfWork unitOfWork,
    ICacheService cache) : IRequestHandler<RejectFlashSaleCommand, FlashSaleDto>
{
    public async Task<FlashSaleDto> Handle(RejectFlashSaleCommand request, CancellationToken cancellationToken)
    {
        ...
        flashSale.Reject(request.Reason);
